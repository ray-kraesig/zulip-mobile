...
const eventUserGroupUpdate = (state: UserGroupsState, action: EventUserGroupUpdateAction): UserGroupsState =>
  state.map(userGroup =>
...
const eventUserGroupAddMembers = (state: UserGroupsState, action: EventUserGroupAddMembersAction): UserGroupsState =>
  state.map(userGroup =>
    action.group_id !== userGroup.id
      ? userGroup
      : {
...
const eventUserGroupRemoveMembers = (state: UserGroupsState, action: EventUserGroupRemoveMembersAction): UserGroupsState =>
  state.map(userGroup =>
    action.group_id !== userGroup.id
      ? userGroup
      : {
