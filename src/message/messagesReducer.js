...
const eventReactionRemove = (state: MessagesState, action: EventReactionRemoveAction): MessagesState => {
  const oldMessage = state[action.message_id];
  if (!oldMessage) {
    return state;
  }
...
const eventSubmessage = (state: MessagesState, action: EventSubmessageAction): MessagesState => {
...
const eventMessageDelete = (state: MessagesState, action: EventMessageDeleteAction): MessagesState => {
...
const eventUpdateMessage = (state: MessagesState, action: EventUpdateMessageAction): MessagesState => {
  const oldMessage = state[action.message_id];
  if (!oldMessage) {
    return state;
  }
