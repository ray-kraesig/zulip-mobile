...
const eventNewMessage = (state: UnreadHuddlesState, action: EventNewMessageAction): UnreadHuddlesState => {
...
const eventUpdateMessageFlags = (state: UnreadHuddlesState, action: EventUpdateMessageFlagsAction): UnreadHuddlesState => {
  if (action.flag !== 'read') {
    return state;
  }
