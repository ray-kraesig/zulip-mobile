...
const messageFetchComplete = (state: NarrowsState, action: MessageFetchCompleteAction): NarrowsState => {
...
const eventMessageDelete = (state: NarrowsState, action: EventMessageDeleteAction): NarrowsState => {
  let stateChange = false;
  const newState: NarrowsState = {};
  Object.keys(state).forEach(key => {
...
const eventUpdateMessageFlags = (state: NarrowsState, action: EventUpdateMessageFlagsAction): NarrowsState => {
